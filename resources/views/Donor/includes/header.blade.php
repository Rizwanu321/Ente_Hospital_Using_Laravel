<span class="errspns"></span>
    <header class="site-header">
        ...
        <div class="nav-bar-main" role="navigation">
            <div class="container">
                <div class="row">
                    <nav style="width: 1260px;" class="main-navigation clearfix visible-md visible-lg" id="bs-example-navbar-collapse-1" role="navigation">
                     ...
                     <li class=""><a href="{{ URL::to('Donor/bloodcenter') }}" class="hvr-bounce-to-bottom-2 m1-2" style="font-size: 13px">Blood Centers</a> </li>
