<span class="errspns"></span>
    <header class="site-header">
            ...
            <div class="row">
                ...
                <div class="header-right">
                    ...
                    <div class="header-login-right-desk">
                        <ul>
                            <li><a href="{{ URL::to('User/register') }}" class="reg-btn hvr-bounce-to-bottom m1">Register</a></li>
        ...
        <div class="nav-bar-main" role="navigation">
            <div class="container">
                <div class="row">
                    <nav style="width: 1100px;" class="main-navigation clearfix visible-md visible-lg" id="bs-example-navbar-collapse-1" role="navigation">
                        <ul class="main-menu sf-menu">
                                                       <li class=""><a href="{{ URL::to('/') }}" class="hvr-bounce-to-bottom-2 m1-2">Home </a></li> 
                            <li class=""><a href="{{ URL::to('User/index') }}" class="hvr-bounce-to-bottom-2 m1-2">Search Donor</a></li>

                            
                            <li class=""><a href="{{ URL::to('User/doner') }}" class="hvr-bounce-to-bottom-2 m1-2">Register as Donor</a> </li>
                            <li class=""><a href="{{ URL::to('User/request') }}" class="hvr-bounce-to-bottom-2 m1-2">Register as Requestor</a> </li>
                            <li class=""><a href="{{ URL::to('User/bloodcenter') }}" class="hvr-bounce-to-bottom-2 m1-2">Blood Centers</a></li>
