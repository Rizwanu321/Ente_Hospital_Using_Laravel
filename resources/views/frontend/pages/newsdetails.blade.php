    ...
    <div class="row">
		<div class="col-lg-9 col-md-8  col-sm-8">
			<div class="row">
			  @foreach($p as $p)
				<div class="col-lg-12"><div class="ms_col"><div class="img_col">
								 <ul id="news_slider" class="owl-carousel owl-theme"> <li  class="item ">  <img src="uploads/news/{{$p->id}}/{{$p->image_name}}" title="" alt="" class="img-responsive"></li></ul> 
			...
			<div class="more_news">
				...
				<li>
								<a href="http://gghbeach.com/news-details.php?id=25">
									<figure class="thump_img"> <img src="../../uploads/news/{{$b->id}}/{{$b->image_name}}"/></figure>
								   <div class="thump_cont"> <p>{{$b->name}}</p></div>
								</a>
							</li>
							 @endforeach
							 </ul>
